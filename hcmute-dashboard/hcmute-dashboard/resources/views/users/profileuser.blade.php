            ...
            <div class="panel-body profile-information">
               <div class="col-md-3">
                   <div class="profile-pic text-center">
                       <img src="{{ URL::asset('images/lock_thumb.jpg') }}" alt=""/>
                   </div>
               </div>
               <div class="col-md-6">
                                ...
                                <div class="recent-act">
                                    ...
                                    <div class="activity-desk">
                                        ...
                                        <div class="photo-gl">
                                            <a href="#">
                                                <img src="
                                                {{ URL::asset('images/sm-img-1.jpg') }}" alt=""/>
                                            </a>
                                            <a href="#">
                                                <img src="
                                                 {{ URL::asset('images/sm-img-2.jpg') }}" alt=""/>
                                            </a>
                                            <a href="#">
                                                <img src="{{ URL::asset('images/sm-img-3.jpg') }}" alt=""/>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="prf-box">
                                    ...
                                    <div class=" wk-progress tm-membr">
                                        <div class="col-md-2 col-xs-2">
                                            <div class="tm-avatar">
                                                <img src="
                                                {{ URL::asset('images/lock_thumb.jpg') }}" alt=""/>
                                            </div>
                                        </div>
                                    ...
                                    <div class=" wk-progress tm-membr">
                                        <div class="col-md-2 col-xs-2">
                                            <div class="tm-avatar">
                                                <img src="
                                                {{ URL::asset('images/avatar-mini-2.jpg') }}" alt=""/>
                                            </div>
                                        </div>
                                        <div class="col-md-7 col-xs-7">
                                            <span class="tm">John Boltana</span>
                                    ...
                                    <div class=" wk-progress tm-membr">
                                        <div class="col-md-2 col-xs-2">
                                            <div class="tm-avatar">
                                                <img src="
                                                 {{ URL::asset('images/avatar-mini-3.jpg') }}" alt=""/>
                                            </div>
                                        </div>
                                        <div class="col-md-7 col-xs-7">
                                            <span class="tm">John Boltana</span>
                                    ...
                                    <div class=" wk-progress tm-membr">
                                        <div class="col-md-2 col-xs-2">
                                            <div class="tm-avatar">
                                                <img src=" {{ URL::asset('images/avatar-mini-4.jpg') }}" alt=""/>
                                            </div>
                                        </div>
                                        <div class="col-md-7 col-xs-7">
                                            <span class="tm">John Boltana</span>
                    ...
                    <div id="settings" class="tab-pane ">
                        <div class="position-center">
                            ...
                            @if(Session::has('errorprofile'))
                                <label style="color:#e74c3c;">{{Session::get('errorprofile')}}</label>
                                {{Session::forget('errorprofile')}}
                            @endif
                            <form role="form" id="formsettinguser" class="form-horizontal" method="POST" action="{{Asset('profile-user')}}" enctype="multipart/form-data">
                                @if(isset($id))
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="file" name="avatar" id="exampleInputFile" class="file-pos">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Công Ty</label>
                                    <div class="col-lg-6">
                                        <input type="text" name="company" placeholder=" " id="c-name" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Địa Chỉ</label>
                                    <div class="col-lg-6">
                                        <input type="text" name="adress"placeholder=" " id="lives-in" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="prf-contacts sttng">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" name="twitter" placeholder=" " id="twitter" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Google plus</label>
                                    <div class="col-lg-6">
                                        <input type="text" placeholder=" " id="g-plus" name="google_plus" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Flicr</label>
                                    <div class="col-lg-6">
                                        <input type="text" placeholder=" " id="flicr" name="flicr" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="prf-contacts sttng">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="email" name="email" placeholder=" " id="email" class="form-control">
                                    </div>
                                </div>
